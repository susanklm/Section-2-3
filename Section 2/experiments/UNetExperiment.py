...
class UNetExperiment:
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # ANSWER: First dimension is batch size, second dimension is the probabilities label (0, 1, or 2), 
            # third dimension is image width, fourth dimension is image height
