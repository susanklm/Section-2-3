...
def create_report(inference, header, orig_vol, pred_vol):
    ...
    draw.multiline_text((10, 90),
                         ...
                         f"Series Instance UID: {header.SeriesInstanceUID}\n"
    ...
    pred_pil_i = Image.fromarray(pred_nd_img, mode="L").convert("RGBA").resize((500,500))
    pimg.paste(pred_pil_i, box=(600, 320))
...
if __name__ == "__main__":
    ...
    inference_agent = UNetInferenceAgent(
        device="cpu",
        parameter_file_path=r"/home/workspace/model.pth")
